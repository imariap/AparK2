...
public class DropShadowBorder implements Border {
    ...
    private Map<Position,BufferedImage> getImages(Graphics2D g2) {
        ...
        if (images == null) {
            ...
            BufferedImage image =GraphicsEnvironment.getLocalGraphicsEnvironment().
                getDefaultScreenDevice().getDefaultConfiguration().createCompatibleImage(imageWidth, imageWidth,
            ...
            BufferedImage targetImage = GraphicsEnvironment.getLocalGraphicsEnvironment().
                getDefaultScreenDevice().getDefaultConfiguration().createCompatibleImage(imageWidth, imageWidth,
                    Transparency.TRANSLUCENT);
    ...
    private BufferedImage getSubImage(BufferedImage img,
        ...
        BufferedImage ret = GraphicsEnvironment.getLocalGraphicsEnvironment().
            getDefaultScreenDevice().getDefaultConfiguration().createCompatibleImage(w, h,
                Transparency.TRANSLUCENT);
